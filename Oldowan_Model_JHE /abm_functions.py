...
def add_run_data(conn, data):
    ...
    try:
        sql_run_dat = """ INSERT INTO run_data(run_id, datetime, n_time_steps, num_agents, num_sources, num_trees, condition, treesdie,
            tool_acq, search_rad, tree_deaths, max_use_per_use)
